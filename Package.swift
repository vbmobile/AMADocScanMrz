...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "AMADocScanMrz",
            url: "https://vbmobileidstorage.blob.core.windows.net/ios/AMADocScanMrz/AMADocScanMrz-3.2.3.zip",
            checksum: "1ef7dc498a2690d083918dc5daf8195af624fc3425a1cffd6999e7ec0c56263a"
        ),
        .target(

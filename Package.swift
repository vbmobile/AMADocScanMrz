...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "AMADocScanMrz",
            url: "https://vbmobileidstorage.blob.core.windows.net/ios/AMADocScanMrz/AMADocScanMrz-3.2.2.zip",
            checksum: "728246d909390767ea73e7532077fc8858d36bfe376d1217dd8fe8d67d08e9dc"
        ),
        .target(
